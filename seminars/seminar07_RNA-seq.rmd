...
```{r}
dat <- read.table("../examples/bottomly/data/bottomly_count_table.tsv", header=TRUE, row.names=1)
des <- read.table("../examples/bottomly/data/bottomly_phenodata.tsv", header=TRUE, row.names=1)
str(dat)
show(des)
