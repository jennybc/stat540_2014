% Seminar 10: Classification and Regularization
...
Install the following packages from Bioconductor: `CMA`, `ROCR`, `GEOquery`, and from CRAN: `car`, `e1071` (for SVM), and `glmnet`.
...
if(file.exists("class_LNstatus.Rdata")){ # if previously downloaded
  ...
  datgeo<-getGEO('GSE23177', GSEMatrix=T) # takes a several mins!; returns a list
