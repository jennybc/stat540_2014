% Jenny Bryan & Katayoon Kasaian - Gloria revision
% 2014-01-18
# Seminar 3: Introduction to R graphics - "Lattice" package
...
If you have not loaded this package already, do it now:
...
# kDat <- read.table("../data/photoRec/GSE4051_MINI.txt",header=TRUE,row.names=1) 
# str(kDat)
