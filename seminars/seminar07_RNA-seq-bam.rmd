...
bamDat <- readAligned("../examples/drosophilaRnaSeq/data/drosophilaMelanogasterSubset.bam", type="BAM")
...
```{r, eval=FALSE}
indexFile <- indexBam("../examples/drosophilaRnaSeq/data/drosophilaMelanogasterSubset.bam")
```
